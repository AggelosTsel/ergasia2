...
public class School {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            courses[0] = new Course("S" , "Science");
            courses[1] = new Course("G" , "Gymnastics");
            courses[2] = new Course("C" , "Computers");
            courses[3] = new Course("A" , "Albanian");
            courses[4] = new Course("H" , "History");
        }
